 uIn order for this asset to work, you need to download spine-unity package V4.1:
...
**** Please consider leaving a review on the assetstore page (https://assetstore.unity.com/packages/slug/174782). This will greatly help us updating the package and create more assets

...
public class G : MonoBehaviour
{
    ...
    /// by CampaignManager.Start() when a run is active; if CampaignManager is absent from the
    /// scene, G keeps using its own Inspector-wired defaults untouched. See docs/G.md.
    /// </summary>

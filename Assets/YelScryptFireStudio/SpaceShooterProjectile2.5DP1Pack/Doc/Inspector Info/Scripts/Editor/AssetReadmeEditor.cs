...
namespace SSP25DP1
{
    [CustomEditor(typeof(SSP25DP1AssetReadme))]
    //[InitializeOnLoad]
    public class AssetReadmeEditor : Editor
    {
        ...
        [MenuItem("Window/Yel Scrypt Fire Studio/Space Shooter Projectile 2.5D Part 1/Asset Info")]
        private static SSP25DP1AssetReadme SelectReadme()
        {
            var ids = AssetDatabase.FindAssets("SSP25DP1AssetReadme t:SSP25DP1AssetReadme");
            ...
            if (ids.Length == 1)
            {
                ...
                return (SSP25DP1AssetReadme)readmeObject;
            }
            else
            {
        ...
        {
            var readme = (SSP25DP1AssetReadme)target;

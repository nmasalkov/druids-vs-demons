...
namespace SSP25DP1
{
	[CustomEditor(typeof(SSP25DP1PublisherReadme))]
	[InitializeOnLoad]
	public class PublisherReadmeEditor : Editor
	{
		...
		[MenuItem("Window/Yel Scrypt Fire Studio/Space Shooter Projectile 2.5D Part 1/Support And Docs")]
		private static SSP25DP1PublisherReadme SelectReadme()
		{
			var ids = AssetDatabase.FindAssets("SSP25DP1PublisherReadme t:SSP25DP1PublisherReadme");
			...
			if (ids.Length == 1)
			{
				...
				return (SSP25DP1PublisherReadme)readmeObject;
			}
			else
			{
		...
		{
			var readme = (SSP25DP1PublisherReadme)target;

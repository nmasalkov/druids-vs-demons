...
namespace SSP25DP1
{
	...
	public class PublisherWelcomeScreen : EditorWindow
	{
		...
		private static Texture2D SSP25DP2Icon;
		...
		private void OnGUI()
		{
			...
			if (DrawButton(allOurAssetsIcon, "Unity Assets",
				"All our assets."))
			{
				Application.OpenURL("https://assetstore.unity.com/publishers/50616");
			}

			if (DrawButton(SSP25DP2Icon, "Space Shooter Projectile 2.5D Part 2 Package",
				"Here's part 2. Buy Now!!!."))
			{
				Application.OpenURL("https://u3d.as/32vc");
			}
		...
		private static bool Init()
		{
			try
			{
				...
				SSP25DP2Icon = Resources.Load("SSP25DP2_Icon") as Texture2D;
		...
		[MenuItem("Window/Yel Scrypt Fire Studio/Space Shooter Projectile 2.5D Part 1/Welcome Screen", false)]
